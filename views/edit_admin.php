    ...
    <div class="users">
        <div class="user-list">
            <?php foreach ($people as $person) : ?>
                <form action="index.php?module=edit&action=view_admins" method="post">
            ...
            <?php endforeach; ?>
            <form method="post" action="index.php?module=edit&action=add_admin">
                <button name="add_usr_btn" type="submit">+ Add Admin</button>
            </form>
        </div>
        <div class="user-box">
            <?php if ($this->is_adding_user) : ?>
                <form class="user-info" method="post" action="index.php?module=edit&action=add_admin">
            ...
            <?php elseif ($this->current_editing) : ?>
                <form class="user-info" method="post" action="index.php?module=edit&action=view_admins">
                    <div>
